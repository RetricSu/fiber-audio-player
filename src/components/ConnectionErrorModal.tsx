    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div
              className="w-full max-w-lg rounded-2xl bg-fiber-surface border border-fiber-border shadow-2xl overflow-hidden"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Header */}
              <div className="flex items-center justify-between p-5 border-b border-fiber-border">
              ...
              {/* Footer */}
              <div className="flex items-center justify-end gap-3 p-5 border-t border-fiber-border bg-fiber-dark/20">
                <button
                  onClick={onClose}
